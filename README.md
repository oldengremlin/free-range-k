...
| `s` | помаранчевий | **shared** — VLAN ID активний одночасно на двох і більше роутерах (тільки в Global-вкладці) |
...
Опції:
  ...
  -G, --global                  Додати першу вкладку «Global» із зведеною картою VLAN по всіх роутерах (вимагає --web)
